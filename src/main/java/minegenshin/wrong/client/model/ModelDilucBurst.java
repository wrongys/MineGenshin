...
public class ModelDilucBurst extends ModelBiped {
    ...
    public ModelDilucBurst() {
        ...
        zhengti.setRotationPoint(1.0F, 19.0F, 3.0F);
        ...
        cube_r27.cubeList.add(new ModelBox(cube_r27, 6, 49, 0.0F, 0.0F, 0.0F, 1, 1, 6, 0.0F, false));

        cube_r28 = new ModelRenderer(this);
        cube_r28.setRotationPoint(3.5F, 8.0F, -22.0F);
        bone5.addChild(cube_r28);
        setRotationAngle(cube_r28, -0.9599F, 0.0F, 0.0F);
        cube_r28.cubeList.add(new ModelBox(cube_r28, 0, 29, -0.5F, 0.0F, 0.0F, 1, 1, 6, 0.0F, false));

        cube_r29 = new ModelRenderer(this);
        cube_r29.setRotationPoint(2.65F, 8.0F, -22.0F);
        bone5.addChild(cube_r29);
        setRotationAngle(cube_r29, -0.9599F, 0.0F, 0.2182F);
        cube_r29.cubeList.add(new ModelBox(cube_r29, 0, 11, -1.0F, 0.0F, 0.0F, 1, 1, 6, 0.0F, false));
        ...
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 20, -3.0F, -10.0F, 12.0F, 6, 6, 3, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, -1.0F, -15.0F, 15.0F, 2, 4, 7, 0.0F, false));
        bb_main.cubeList.add(new ModelBox(bb_main, 68, 0, -1.0F, -13.0F, 22.0F, 2, 1, 4, 0.0F, false));
        ...
        bb_main_r2.cubeList.add(new ModelBox(bb_main_r2, 49, 49, -1.0F, -5.5F, -1.5F, 2, 8, 3, 0.0F, false));
        ...
        bone7.cubeList.add(new ModelBox(bone7, 146, 87, 60.0F, -6.0F, 0.0F, 19, 2, 8, 0.0F, false));

        cube_r19 = new ModelRenderer(this);
        cube_r19.setRotationPoint(66.0F, -5.0F, 0.0F);
        bone7.addChild(cube_r19);
        setRotationAngle(cube_r19, 0.1309F, 0.0F, 0.0F);
        cube_r19.cubeList.add(new ModelBox(cube_r19, 70, 78, -6.0F, 0.0F, -16.0F, 19, 1, 16, 0.0F, false));
        ...
        cube_r20.cubeList.add(new ModelBox(cube_r20, 118, 58, -6.0F, 0.0F, -18.0F, 12, 1, 18, 0.0F, false));

        cube_r21 = new ModelRenderer(this);
        cube_r21.setRotationPoint(48.0F, -7.0F, 4.0F);
        bone8.addChild(cube_r21);
        setRotationAngle(cube_r21, 0.0F, 0.0F, 0.0436F);
        cube_r21.cubeList.add(new ModelBox(cube_r21, 153, 153, 0.0F, 0.0F, -5.0F, 12, 4, 10, 0.0F, false));
        ...
        cube_r22.cubeList.add(new ModelBox(cube_r22, 68, 20, 0.0F, -1.0F, -6.0F, 25, 5, 12, 0.0F, false));

        cube_r23 = new ModelRenderer(this);
        cube_r23.setRotationPoint(34.0F, -7.0F, -2.0F);
        bone9.addChild(cube_r23);
        setRotationAngle(cube_r23, 0.1309F, 0.0F, 0.0436F);
        cube_r23.cubeList.add(new ModelBox(cube_r23, 0, 20, -11.0F, 1.0F, -18.0F, 25, 2, 18, 0.0F, false));
        ...
        cube_r24.cubeList.add(new ModelBox(cube_r24, 64, 95, -7.5F, 0.5F, -16.5F, 15, 3, 17, 0.0F, false));

        cube_r25 = new ModelRenderer(this);
        cube_r25.setRotationPoint(7.0F, -7.0F, 6.0F);
        bone10.addChild(cube_r25);
        setRotationAngle(cube_r25, 0.0F, 0.0F, 0.0436F);
        cube_r25.cubeList.add(new ModelBox(cube_r25, 113, 100, 0.0F, -3.0F, -10.0F, 16, 6, 15, 0.0F, false));
        ...
        bone4.cubeList.add(new ModelBox(bone4, 146, 77, -79.0F, -6.0F, 0.0F, 19, 2, 8, 0.0F, false));

        cube_r12 = new ModelRenderer(this);
        cube_r12.setRotationPoint(-66.0F, -5.0F, 0.0F);
        bone4.addChild(cube_r12);
        setRotationAngle(cube_r12, 0.1309F, 0.0F, 0.0F);
        cube_r12.cubeList.add(new ModelBox(cube_r12, 0, 78, -13.0F, 0.0F, -16.0F, 19, 1, 16, 0.0F, false));
        ...
        cube_r13.cubeList.add(new ModelBox(cube_r13, 39, 115, -6.0F, 0.0F, -18.0F, 12, 1, 18, 0.0F, false));

        cube_r14 = new ModelRenderer(this);
        cube_r14.setRotationPoint(-48.0F, -7.0F, 4.0F);
        bone3.addChild(cube_r14);
        setRotationAngle(cube_r14, 0.0F, 0.0F, -0.0436F);
        cube_r14.cubeList.add(new ModelBox(cube_r14, 119, 149, -12.0F, 0.0F, -5.0F, 12, 4, 10, 0.0F, false));
        ...
        cube_r15.cubeList.add(new ModelBox(cube_r15, 68, 0, -25.0F, -1.0F, -6.0F, 25, 5, 12, 0.0F, false));

        cube_r16 = new ModelRenderer(this);
        cube_r16.setRotationPoint(-34.0F, -7.0F, -2.0F);
        bone2.addChild(cube_r16);
        setRotationAngle(cube_r16, 0.1309F, 0.0F, -0.0436F);
        cube_r16.cubeList.add(new ModelBox(cube_r16, 0, 0, -14.0F, 1.0F, -18.0F, 25, 2, 18, 0.0F, false));
        ...
        cube_r17.cubeList.add(new ModelBox(cube_r17, 0, 95, -7.5F, 0.5F, -16.5F, 15, 3, 17, 0.0F, false));

        cube_r18 = new ModelRenderer(this);
        cube_r18.setRotationPoint(-7.0F, -7.0F, 6.0F);
        bone.addChild(cube_r18);
        setRotationAngle(cube_r18, 0.0F, 0.0F, -0.0436F);
        cube_r18.cubeList.add(new ModelBox(cube_r18, 98, 37, -16.0F, -3.0F, -10.0F, 16, 6, 15, 0.0F, false));
